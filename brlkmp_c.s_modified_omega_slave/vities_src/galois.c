...
int gmult(int a, int b)
{
  ...
  /*
	int result;
	Xil_Out32(XPAR_MYIP_GF_SLAVE_EXPLIC_0_BASEADDR+4*0, a);
	Xil_Out32(XPAR_MYIP_GF_SLAVE_EXPLIC_0_BASEADDR+4*1,b);
	    //delay(1000);
	result = Xil_In32(XPAR_MYIP_GF_SLAVE_EXPLIC_0_BASEADDR+4*2);
	return result;
*/
}
